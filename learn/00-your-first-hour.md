...
1. **A real business goal.** Write down, in `KB/Goals/`, the actual outcome you are working towards on your own business. Not a Nexus goal, a real one. The agents and tooling that come later are the means, never the goal itself.
...
Day one is not done by hand. The setup prompt interviews you, then scaffolds the folders, the goal, the map, the failure log, and the commands for you. You answer a handful of questions and it builds the structure around your real work.

The substrate you need first: git, a persistent AI development environment such as Claude Code, a terminal, and markdown. If you have those, you are ready.
