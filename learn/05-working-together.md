...
![Connected operators: separate nexus points linked first through the human and markdown layer, comparing failure logs and field reports](./images/connected-operators.png)
